...
//	private static final SimpleDateFormat DATEFORMATRADICALSENTIMENT= new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
	static final String DATEFORMAT1 = "dd/MM/yyyy HH:mm:ss";
	static final String DATEFORMAT2 = "dd/MM/yyyy HH.mm.ss";
	...
	{		
		...
		if(StrDate.contains(".")){
			dateFormat = new SimpleDateFormat(DATEFORMAT2);
		}
		else if(StrDate.contains(":")){
			dateFormat = new SimpleDateFormat(DATEFORMAT1);
		}
